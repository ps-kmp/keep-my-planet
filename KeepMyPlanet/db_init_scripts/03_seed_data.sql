...
(39.750000, -8.800000, 'Minor debris along the Lis River banks after recent rains.', 3, 'REPORTED', 'LOW', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(37.016670, -7.933330, 'Forest trail near Faro is littered with camping waste.', 4, 'REPORTED', 'MEDIUM', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(38.7593, -9.1553, 'Litter scattered around Jardim do Campo Grande.', 5, 'REPORTED', 'HIGH', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(40.6405, -8.6538, 'Some trash found near the University of Aveiro campus.', 6, 'REPORTED', 'LOW', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
