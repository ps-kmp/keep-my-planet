...
fun ReportZoneScreen(
    ...
    val formState = uiState.reportForm
    ...
    LaunchedEffect(Unit) {
        viewModel.events.collectLatest { event ->
            when (event) {
                is ZoneScreenEvent.ShowSnackbar -> snackbarHostState.showSnackbar(event.message)
                is ZoneScreenEvent.ReportSuccessful -> onNavigateBack()
            }
        }
    }
