...
class DatabaseEventStateChangeRepository(
    ...
    override suspend fun save(eventStateChange: EventStateChange): EventStateChange = create(eventStateChange)
    ...
    override suspend fun getAll(limit: Int, offset: Int): List<EventStateChange> {
